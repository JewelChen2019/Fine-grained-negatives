...
def smi_value(sent,batchs_video_features,batchs_video_mask):
    ...
    b1b2_logits, *_tmp = model.get_similarity_logits(eot_tokens,text_features, batchs_video_features, batchs_video_pixel_features,attention_mask, batchs_video_mask,shaped=True, loose_type=model.loose_type)
...
# csv_ptest_id_pathath = '/var/scratch/achen/VisualSearch/msrvtt10k//TextData/MSRVTT_JSFUSION_test.csv'
...
# test_p = '/var/scratch/achen/VisualSearch/vln_uvo/hardnegative/captions.txt'
# test_p = '/home/caz/VisualSearch/vln_uvo/hardnegative/captions.txt'
test_p  = '/var/scratch/achen/VisualSearch/msrvtt10k/TextData/msrvtt10ktest.caption.txt'
...
changeS_P = '/var/scratch/achen/VisualSearch/msrvtt10k/hardnegative/'
# changeS_P = '/home/caz/VisualSearch/msrvtt10k/hardnegative/'
test_list = ['msr1ka_ChangeADP_RE20_20230925.json','msr1ka_ChangeVP_RE20_20230925.json','msr1ka_ChangeNP_RE20_20230925.json','msr1ka_ChangeVerb_RE20_20230925.json','msr1ka_ChangeNoun_RE20_20230925.json' ]
import numpy
from tqdm import tqdm
import torch
