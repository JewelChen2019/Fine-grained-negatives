...
def get_args(description='X-CLIP on hard negative samples augmentation Retrieval Task'):
    ...
    parser.add_argument('--loss_func', type=str, default="fineGrained",
                        choices=["fineGrained", "triplet",'maxcol', "boundary", "maxcol_word",'maxcol_phrase',"hierachicalRank_word","hierachicalRank_phrase",'mix','maxcol_v2t_word','maxcol_v2t_phrase','maxcol_v2t_word_phrase','maxcol_weight_coarse_word_phrase','maxcol_weight_word_phrase'],
