...
from modules.until_module import PreTrainedModel, AllGather, CrossEn,TripletLoss,Margin2Loss
...
class XCLIP(CLIP4ClipPreTrainedModel):
    ...
    # def forward(self, input_ids, token_type_ids, attention_mask, video, video_mask=None):
        ...
        if self.training:
            ...
            #只计算 boundary loss
            sim_loss = (sim_loss1 + sim_loss2)/2 + 0.01*(sim_loss_boundary_t2t+ sim_loss_boundary_t2v )
