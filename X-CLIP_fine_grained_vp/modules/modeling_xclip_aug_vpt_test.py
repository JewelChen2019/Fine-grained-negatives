...
from modules.module_clip_vpt_test import CLIP, convert_weights
...
class XCLIP(CLIP4ClipPreTrainedModel):
    ...
    def get_visual_output(self, video, video_mask, shaped=False, video_frame=-1):
        ...
        # visual_hidden,visual_prompt = self.clip.encode_image(video, ,return_vp=True, video_frame=video_frame).float()
        # visual_prompt_embed = visual_prompt.view(bs_pair, -1, visual_prompt.size(-1))
