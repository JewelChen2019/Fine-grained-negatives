...
dataset_based_vocab_path=  '/var/scratch/achen/VisualSearch/vln_oops/hardnegative/vln_oops_word_dic_20230920.json'
...
class OOPS_TrainDataLoader(Dataset):
    """OOPS dataset loader."""
    def __init__(
            self,
            subset,
        ...
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "vln_oops_train.txt")
        video_id_path_dict["val"] = os.path.join(self.data_path, "vln_oops_val.txt")
        video_id_path_dict["test"] = os.path.join(self.data_path, "vln_oops_val.txt")
        caption_file = os.path.join(self.data_path, "vln_oops.pkl")
